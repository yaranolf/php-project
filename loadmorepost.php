<?php
    ...
    include 'classes/Post.php';
        ...
        $html .= '<p class="date">'.$convertedDate = Post::convertTime($time_ago).'</p>';
        $html .= '<p class="location">('.$post->latitude.','.$post->longitude.')</p>';
        ...
        $html .= '<div class="center-div"><a href="#" data-id="'.$post->id.'" class="like ">Like</a> <span class="likes">'.$post->getLikes().'</span> people like this </div>';
        $html .= '<div class="center-div"><a href="#" class="report " data-id="'.$post->id.'" >Inappropriate</a> <span class="inappropriate">'.implode($post->getNrOfInappropriate()).'</span> people report this </div>';
        $html .= '</article>';
        $html .= '</section';
